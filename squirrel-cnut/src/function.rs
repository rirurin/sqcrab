...
macro_rules! trap {
    ($s:ident) => {
        ...
        if from_slice!(slice, u32, crate::utils::endianness::LittleEndian, 0x0) != crate::binary::TRAP {
            return Err(Box::new(crate::utils::error::SquirrelBinaryError::ExpectedTrap));
        }
